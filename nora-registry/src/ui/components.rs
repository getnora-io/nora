...
pub mod icons {
    ...
    pub const RPM: &str = r#"<path fill="currentColor" d="M12 1 2 6v12l10 5 10-5V6L12 1zm0 2.2 7.5 3.7L12 10.7 4.5 6.9 12 3.2zM4 8.6l7 3.5v8.3l-7-3.5V8.6zm16 8.3-7 3.5v-8.3l7-3.5v8.3z"/>"#;
}
